...
# if the program couldn't reassemble alot of words from your text , try "complexFullTextConverter.py" instead
    ...
    for line in file:
        for word in line.split():
            ...
            if len(word) == 1:
                ...
                for i, line in enumerate(open("D:\My Projects\Python Projects\\text_converter\wordlist.10000.txt")):
